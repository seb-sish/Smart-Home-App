...
public class TempModule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temp_module);
...
//                        Toast.makeText(HomeControlActivity.this, "Successfully Read",Toast.LENGTH_SHORT).show();
                    ...
                    } else { Toast.makeText(TempModule.this,"Отсутствуют данные в базе данных!",Toast.LENGTH_SHORT).show(); }
                } else { Toast.makeText(TempModule.this,"Ошибка при чтении данных!",Toast.LENGTH_SHORT).show(); }
            }
        });
    }
